package AdvancedJava.Ereditarietà;



/*
* Definire una classe chiamata Shape che abbia:


Definisci una classe di test in cui:

creare i 5 Shape  oggetti utilizzando tutte le diverse invocazioni del costruttore
invocare getShapeDetails()
* per ogni Shape oggetto e assegnare i valori restituiti
*  a String variabili dedicate
stampa in console i valori delle 5 String variabili dedicate
*
* */
public class Shape {

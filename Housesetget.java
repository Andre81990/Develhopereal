...
/*
*
* Ottieni l'incapsulamento utilizzando
*  getter / setter per una classe House
* che ha le seguenti variabili di istanza:
----un intfloors Number
----una stringa address
----un array di stringheresidents Names

*
* utilizzare una classe tester per:
-----impostare i valori chiedendo all'utente di inserirli
per il residentsNames, l'utente dovrà inserire un elenco di nomi separati da una virgola (es John,Lucy,Peter)
stampa i dettagli della casa usando i getter eString.format()
*
* */
